...
';
//./rsty/mail/sie%20haben%20post.wav
}
$h=-30;
$p=29.5;
$po=$p;
function adminml($a){
	...
	if($_SESSION["login2"]=="admin"){
		if($a=="r2r:admin:m"){$b="r2r:admin:m";} else {$b=$ml."?page=admin&amp;site=".$a;}
		return $b;
	}
}
function memberml($a){
...
if($site=="posteingang")echo '<frame posn="0 -10" >';
include("./rsty/member/$site.php");
if($site=="posteingang")echo '</frame>';
