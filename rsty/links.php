...
<label posn="'.$posx.' '.($posy+1.6).' 16" style="TextTitle2Blink" halign="center" valign="center">$0F0Add your
    ML!$z</label>
';
} else {
echo '
...
<label posn="'.$posx.' '.$posy.' 16" style="TextCardRaceRank" sizen="11 4" manialink="'.$links[$u][1].'" halign="center" valign="center">$o'.$links[$u][2].'$z</label>
';
...
<label halign="right" posn="'.($posx-4.5).' '.($posy+4).' 22" sizen="6 2.5" style="TextSubTitle1" text="$fffX" textcolor="FFF" manialink="'.$ml.'?page=admin&amp;site=links_edit&amp;delete='.($u+0).'" />
';
}
}
$posx=$posx+14;
